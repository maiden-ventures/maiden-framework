package maiden.util.time

import com.github.benhutchison.mouse.all._
import com.twitter.util.Try
import maiden.util.time.TaggedTypesFunctions.{Millis, Seconds}
import maiden.util.time.Time.iso8601Formatter
...
object Time {
  ...
  private[maiden] val iso8601Parser = ISODateTimeFormat.dateTimeParser.withOffsetParsed()
