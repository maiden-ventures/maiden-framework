...
import maiden.util.hawk.TaggedTypesFunctions.{ExtendedData => _, Nonce => _, PayloadHash => _, RawAuthenticationHeader => _}
import maiden.util.hawk.validate.{MAC, RequestAuthorisationHeader}
import maiden.util.hawk.{TaggedTypesFunctions => UTTF, _}
